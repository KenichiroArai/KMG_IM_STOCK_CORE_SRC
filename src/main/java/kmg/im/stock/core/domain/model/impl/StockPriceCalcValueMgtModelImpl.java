...
public class StockPriceCalcValueMgtModelImpl implements StockPriceCalcValueMgtModel {
     ...
     *                              サプライヤリスト
     */
    public StockPriceCalcValueMgtModelImpl(final ImStkSpcvInitMgtModel tsstsSpcvInitMgtModel,
        ...
        for (int i = 0; i < tsstsSpcvInitMgtModel.getDataList().size(); i++) {
            final ImStkSpcvInitModel tsstsSpcvInitModel = tsstsSpcvInitMgtModel.getDataList().get(i);
