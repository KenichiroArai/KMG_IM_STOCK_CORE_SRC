...
import kmg.im.stock.core.domain.service.ImStkSmaService;

/**
 * 投資株式単純移動平均サービスインタフェース<br>
 *
...
@Service
@Scope("prototype")
public class ImStkSmaServiceImpl implements ImStkSmaService {
     ...
     *                      投資株式単純移動平均ロジック
     */
    public ImStkSmaServiceImpl(final ImStkSmaLogic imStkSmaLogic) {
    ...
    public void calc() {
        ...
        final List<Supplier<BigDecimal>> tmpList = this.imStkSmaLogic.calc(this.dataList, this.calcDays);
