...
@Service
public class ImStkStockPriceTimeSeriesModelImpl implements ImStkStockPriceTimeSeriesModel {
    ...
    /** 投資株式株価計算値モデルのマップ */
    private final SortedMap<ImStkStockPriceCalcValueTypeTypes, ImStkStockPriceCalcValueModel> spcvModelMap;
     ...
     * @version 1.0.0
     */
    public ImStkStockPriceTimeSeriesModelImpl() {
     ...
     *                                          投資株式株価計算値の種類の種類
     * @param imStkStockPriceCalcValueModel
     *                                          投資株式株価計算値モデル
     */
    @Override
    public void addSpcvModel(final ImStkStockPriceCalcValueTypeTypes imStkStockPriceCalcValueTypeTypes,
        final ImStkStockPriceCalcValueModel imStkStockPriceCalcValueModel) {
        this.spcvModelMap.put(imStkStockPriceCalcValueTypeTypes, imStkStockPriceCalcValueModel);
    }
     ...
     */
    @Override
    public ImStkStockPriceCalcValueModel getImStkStockPriceCalcValueModel(
        final ImStkStockPriceCalcValueTypeTypes imStkStockPriceCalcValueTypeTypes) {
        final ImStkStockPriceCalcValueModel result = this.spcvModelMap.get(imStkStockPriceCalcValueTypeTypes);
        return result;
    }
