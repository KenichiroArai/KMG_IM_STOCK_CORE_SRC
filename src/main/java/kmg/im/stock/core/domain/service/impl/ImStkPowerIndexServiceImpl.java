...
@Service
@Scope("prototype")
public class ImStkPowerIndexServiceImpl implements ImStkPowerIndexService {
     ...
     *                アプリケーションコンテキスト
     */
    public ImStkPowerIndexServiceImpl(final ApplicationContext context) {
        this.context = context;
        this.smoothingPeriod = ImStkPowerIndexServiceImpl.DEFAULT_SMOOTHING_ST;
    ...
    public void smoothing(final int smoothingPeriod) {
        ...
        /* スムーズ化 */
        final ImStkEmaService imStkEmaService = this.context.getBean(ImStkEmaService.class);
        imStkEmaService.initialize(this.calcResultList, this.smoothingPeriod);
        imStkEmaService.calc();
        final List<Supplier<BigDecimal>> smoothingTmpList = imStkEmaService.getClacResultList();
    ...
    public void defaultStSmoothing() {
        ...
        this.smoothing(ImStkPowerIndexServiceImpl.DEFAULT_SMOOTHING_ST);
    }
    ...
    public void defaultLtSmoothing() {
        ...
        this.smoothing(ImStkPowerIndexServiceImpl.DEFAULT_SMOOTHING_LT);
    }
