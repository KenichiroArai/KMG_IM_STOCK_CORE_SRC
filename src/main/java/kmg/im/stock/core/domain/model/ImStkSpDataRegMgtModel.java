...
/**
 * 投資株式株価データ登録管理モデルインタフェース<br>
 *
 * @author KenichiroArai
 * @sine 1.0.0
 * @version 1.0.0
 */
public interface ImStkSpDataRegMgtModel {
     ...
     *             投資株式株価データ登録モデル
     */
    void addData(ImStkSpDataRegModel data);
     ...
     */
    void addAllData(List<ImStkSpDataRegModel> addData);
     ...
     */
    List<ImStkSpDataRegModel> getDataList();
}
