...
public interface ImStkStockPriceTimeSeriesModel extends Supplier<BigDecimal>, ImStkPowerIndexCalcModel {
    ...
    void addSpcvModel(final ImStkStockPriceCalcValueTypeTypes imStkStockPriceCalcValueTypeTypes,
        final ImStkStockPriceCalcValueModel stockPriceCalcValueModel);
     ...
     * @return 投資株式株価計算値モデル
     */
    ImStkStockPriceCalcValueModel getImStkStockPriceCalcValueModel(
