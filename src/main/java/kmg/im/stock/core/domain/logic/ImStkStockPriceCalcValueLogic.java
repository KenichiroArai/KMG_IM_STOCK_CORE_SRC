...
/**
 * 投資株式株価計算値ロジックインタフェース<br>
 *
 * @author KenichiroArai
 * @sine 1.0.0
 * @version 1.0.0
 */
public interface ImStkStockPriceCalcValueLogic {
     ...
     *                              投資株式ドメイン例外
     */
    void register(final ImStkStockPriceCalcValueMgtModel imStkStockPriceCalcValueMgtModel) throws ImStkDomainException;
}
