...
import kmg.im.stock.core.domain.logic.ImStkLowestPriceInPastLogic;
import kmg.im.stock.core.domain.service.ImStkLowestPriceInPastService;

/**
 * 投資株式過去の最安値ロジックインタフェース<br>
 *
...
@Service
@Scope("prototype")
public class ImStkLowestPriceInPastServiceImpl implements ImStkLowestPriceInPastService {

    /** 過去の最安値ロジック */
    private final ImStkLowestPriceInPastLogic imStkLowestPriceInPastLogic;
     ...
     * @sine 1.0.0
     * @version 1.0.0
     * @param imStkLowestPriceInPastLogic
     *                                    過去の最安値ロジック
     */
    public ImStkLowestPriceInPastServiceImpl(final ImStkLowestPriceInPastLogic imStkLowestPriceInPastLogic) {
        this.imStkLowestPriceInPastLogic = imStkLowestPriceInPastLogic;
    ...
    public void calc() {
        ...
        final List<Supplier<BigDecimal>> tmpList = this.imStkLowestPriceInPastLogic.calc(this.dataList, this.calcDays);
