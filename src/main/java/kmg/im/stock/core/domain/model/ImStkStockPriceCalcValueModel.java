...
/**
 * 投資株式株価計算値モデルインタフェース<br>
 *
 * @author KenichiroArai
 * @sine 1.0.0
 * @version 1.0.0
 */
public interface ImStkStockPriceCalcValueModel extends Supplier<BigDecimal> {
    ...
    void setSpcvtId(ImStkStockPriceCalcValueTypeTypes spcvtId);
     ...
     */
    ImStkStockPriceCalcValueTypeTypes getSpcvtId();
