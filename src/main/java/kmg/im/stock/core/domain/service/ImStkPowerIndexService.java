...
/**
 * 投資株式勢力指数サービスインタフェース<br>
 *
 * @author KenichiroArai
 * @sine 1.0.0
 * @version 1.0.0
 */
public interface ImStkPowerIndexService {
     ...
     *                 データリスト
     */
    void initialize(final List<ImStkPowerIndexCalcModel> dataList);
     ...
     * @return データリスト
     */
    List<ImStkPowerIndexCalcModel> getDataList();
