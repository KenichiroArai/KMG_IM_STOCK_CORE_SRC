...
@Transactional
public class ImStkMacdLogicImplTests {

    /** テスト対象 */
    @Autowired
    private ImStkMacdLogic testTarget;
    ...
    public void テスト００２_ＭＡＣＤシグナルのリストを返す_正常００１_パターン１() {
        ...
        // 結果を有効桁数を期待値に合わせる
        actualSignalList = actualSignalList.stream().map(KmgDecimal::setResultScale).collect(Collectors.toList());
